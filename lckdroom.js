  ...
  switch(switchvar){
    ...
    case 'N': case 'NORTH':
      if (player.location.n != undefined){
        player.location = locations[player.location.n];
    ...
    case 'S': case 'SOUTH':
      if (player.location.s != undefined){
        player.location = locations[player.location.s];
    ...
    case 'E': case 'EAST':
      if (player.location.e != undefined){
        player.location = locations[player.location.e];
        print('You went East!');
        print('</br>'+player.location.description);
      }else{
    ...
    case 'W': case 'WEST':
      if (player.location.w != undefined){
        player.location = locations[player.location.w];
        print('You went West!');
        print('</br>'+player.location.description);
      }else{
      ...
      if(player.location.items){
        ...
        $.each(player.location.items, function(index,item){
          $.each(item.keywords, function(i,keyword){
            if (keyword.toUpperCase() == words[wordind]){
              player.inventory.push(player.location.items[index]);
...
var items = {
     paper :{
       title: 'Paper',
       keywords : ['paper'],
       description : "A peice of paper.  There's nothing written on it."
     },
     key_lion :{
       title : 'Key',
       keywords : ['key'],
